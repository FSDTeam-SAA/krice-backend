...
const forgotPassword = async (email: string) => {
      ...
      if (!isExistingUser) throw new AppError('No account found with the provided credentials.', StatusCodes.NOT_FOUND);
...
const changePassword = async (
      ...
      if (!isPasswordMatched) throw new AppError('Current password is incorrect', StatusCodes.BAD_REQUEST);
